...
if (isset($_POST['submit'])) {
    ...
    $extensions= array("pdf", "JPG", "jpg", "JPEG", "jpeg", "PNG", "png");
    ...
    <form class="form-control rounded-corner" style="margin-top:20px;" action = "" method = "POST" enctype = "multipart/form-data">
        ...
        <center>
            ...
            <div class="col-lg-3" style="margin-top: 20px;">
                ...
                <input type="date" name="OfferDate" id="myDateInput" class="form-control rounded-corner" required>
            </div>
            <div class="col-lg-4 d-none">
                <input type="text" class="form-control rounded-corner" name="OrderIDOF" id="OdrID">
            </div>
...
//
  ...
  $(document).ready(function() {
    if (!Modernizr.inputtypes.date) {
      // If date input is not supported, use a jQuery date picker library or any other custom solution
