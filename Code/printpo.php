...
//$pdf->Ln();
	...
	$pdf->Cell(20,35,'Total Chargable Amount in words: '.$obj->get_words());
	

	//$pdf->SetDrawColor(50,60,100);
	//$pdf->Cell(187,10,'Total Chargable Amount in words:  '.numberTowords($TAmount),1,0,'C',0);
	...
	$Y= $pdf->GetY();
	$pdf->Image('sign.jpg',160,$Y+40,30,0,'jpeg');
	$pdf->Cell(5,120,'Authorised Signatory');
	$pdf->Cell(-145);	
	$pdf->Cell(5,135,'IT IS MANDATORY w.e.f 01-07-2021, TO DEDUCT TDS U/S 194Q ON BILL VALUE @ 0.1% AS PER GOI.');



	$BankDir='D:/GST BILLS/'.$Bank;
